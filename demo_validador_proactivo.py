...
print("\n" + "="*80)
print("[LAUNCH] DEMOSTRACIÓN: VALIDADOR PROACTIVO DE ESPECIFICACIONES")
print("="*80)
print()
...
if blocked:
    ...
    print("[OK] Ninguna fórmula bloqueada (todas cumplen)")
...
if fatal_count > 0:
    ...
    print(f"\n[OK] TODAS LAS ESPECIFICACIONES CUMPLEN")
...
EJEMPLO: Si alguien intenta cambiar a "presion_vapor_iapws" sin Enhancement Factor:
   [ERROR] BLOQUEADO AUTOMÁTICAMENTE
   [OK] Razón: Incumple especificación (falta parámetro 'humedad')
