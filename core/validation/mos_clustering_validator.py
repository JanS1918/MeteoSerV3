"""
[GUARDIAN] CAPA 39: MOS CLUSTERING VALIDATOR
...
VALIDA:
[OK] Escenario clasificado coherente con condiciones reales
[OK] No hay contradicciones en parámetros (ej: "radiativo" con viento alto)
[OK] Similitud >85% entre eventos del mismo escenario
[OK] No hay drift en la clasificación (estabilidad temporal)
...
class MOSClusteringValidator:
    ...
    def __init__(self, data_dir: str = "data"):
        ...
        logger.info("[OK] MOSClusteringValidator inicializado")
    ...
    def _registrar_error(self, escenario: str, tipo_error: str):
        ...
        logger.warning(
            f"[WARNING] Error clasificación {escenario}: {tipo_error} "
...
def integrar_validador_en_mos():
    ...
    def clasificar_escenario(self, condiciones):
        ...
        if not es_valido:
            logger.error(f"[ERROR] Clasificación inválida: {razon}")
