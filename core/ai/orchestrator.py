...
class AIOrchestrator:
    ...
    def register_subsystem(self, name: str, instance: Any) -> None:
        ...
        with self._lock:
            ...
            logger.info(f"[OK] Subsistema registrado: {name}")
    ...
    def set_bus(self, bus) -> None:
        ...
        if bus:
            ...
            logger.info("[OK] Bus registrado en AIOrchestrator")
        ...
        while self.running:
            ...
            if task:
                try:
                    ...
                    logger.info(f"[OK] Tarea completada: {task.name}")
                    
                except Exception as e:
                    task.status = "failed"
                    task.error = str(e)
                    self.metrics["tasks_failed"] += 1
                    logger.error(f"[ERROR] Error en tarea {task.name}: {e}")
            else:
    ...
    async def _main_loop(self) -> None:
        ...
        logger.info("[LAUNCH] AIOrchestrator loop iniciado")
    ...
    async def start(self) -> None:
        ...
        if self.running:
            logger.warning("[WARNING] AIOrchestrator ya está ejecutándose")
            return
    ...
    async def stop(self) -> None:
        ...
        logger.info("[OK] AIOrchestrator detenido")
