...
class KnowledgeManager:
    ...
    def _load_all(self) -> None:
        ...
        try:
            ...
            logger.info(f"[OK] Conocimiento cargado: {len(self.contracts)} contratos, "
                       f"{len(self.history)} entradas de historial")
        except Exception as e:
            logger.warning(f"[WARNING] Error cargando conocimiento: {e}")
    ...
    def export_knowledge(self, output_path: str) -> None:
        ...
        logger.info(f"[GUARDAR] Conocimiento exportado a: {output_path}")
