...
class AlertFilterSystem:
    ...
    def __init__(self):
        ...
        logger.info("[OK] AlertFilterSystem inicializado (integración CentinelaV30)")
    ...
    def set_filter(self, severity_min: AlertSeverity = None, categories: List[AlertCategory] = None):
        ...
        logger.info(f"[OK] Filtros configurados: severidad>={severity_min}, categorías={len(self.filters['categories'])}")
    ...
    def acknowledge_alert(self, alert_id: str):
        ...
        for alert in self.alerts:
            if alert.alert_id == alert_id:
                ...
                logger.info(f"[OK] Alerta {alert_id} reconocida")
                return True
        return False
