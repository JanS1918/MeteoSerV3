...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[LAUNCH] NUEVO EN V11-V13 DEFINITIVO: LO QUE FALTABA (140+ constantes)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
[STATS] RESUMEN TOTAL V13.0 DEFINITIVO:
...
class BusExpander:
    ...
    async def publish_all_subfactors(self):
        ...
        try:
            ...
            logger.info("[OK] BUS TOTAL V13.0 DEFINITIVO: 450+ CONSTANTES PUBLICADAS - CERO REDUNDANCIA - 100% COBERTURA ABSOLUTA [TARGET]")
    ...
    async def _publish_astronomia(self):
        ...
        try:
            ...
            try:
                ...
                logger.warning("  [WARNING] AstronomiaRecursiva no disponible, usando cálculo simplificado")
                ...
                self.bus.publicar("elevacion_solar", arco, "grados")
            ...
            try:
                ...
                logger.warning(f"  [WARNING] Error calculando fase lunar: {e_luna}")
            
            logger.info("[OK] Astronomía publicada (elevación, azimut, fase lunar + 15 subfactores)")
    ...
    async def _publish_humedad_suelo_et(self):
        ...
        try:
            ...
            logger.info(f"[OK] Suelo/ET publicada (HR_suelo:{humedad_suelo:.0f}%, ET0:{et0:.2f}mm/día, Estrés:{factor_stress:.2f}, Riego:{necesita_riego})")
