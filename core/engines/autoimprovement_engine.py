...
class MotorAutoMejora:
    ...
    def __init__(self, log_engine: Optional[Any] = None):
        if log_engine is not None:
            ...
            self._log = get_logger("MotorAutoMejora")
...
class AutoImprovementSystem:
    ...
    def autoexpandir_formulas_si_hay(self, system_core, indices_actuales: dict, propuestas: list):
        ...
        if not propuestas:
            return []
        if not hasattr(system_core, "autoexpandir_formulas"):
            return []
        return system_core.autoexpandir_formulas(indices_actuales, propuestas)
    ...
    def ciclo(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "nuevas_formulas": nuevas_formulas,
        }
