...
class VectorMemoryEngine:
    ...
    def memorize_anomaly_episode(
        ...
        try:
            ...
            logger.info(f"[CRITICAL] Episodio de anomalia memorizado: {vector_id}")
            return vector_id
        except Exception as e:
    ...
    def recall_similar_situations(
        ...
        try:
            ...
            logger.info(f"[BUSCAR] Encontrados {len(similar)} casos similares a: '{query}'")
            return similar
...
def demo_vector_memory():
    ...
    print("\n" + "="*80)
    print("[OK] DEMO COMPLETADA - Memoria vectorial operativa")
    print("="*80 + "\n")
