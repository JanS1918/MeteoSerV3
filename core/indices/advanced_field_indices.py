...
def confort_ave_porter_gates(temperatura_c: float,
    ...
    Q_solar = absortividad_solar * radiacion_wm2 * area_proyectada_m2 * f_p
    ...
    es_aire = 0.6108 * math.exp((17.27 * temperatura_c) / (temperatura_c + 237.3))
...
def visibilidad_kneizys(pm25_ugm3: float,
    ...
    # Extinción molecular (Rayleigh)
    # Para aire limpio a nivel del mar: β_rayleigh ≈ 0.01 km⁻¹ = 1e-5 m⁻¹
    beta_rayleigh = 1.0e-5 * (550.0 / longitud_onda_nm) ** 4
