...
def calcular_temperatura_minima_deardorff(
    ...
    flujo_calor_latente_wm2: Union[float, np.ndarray] = None,
    ...
    LE_forzado = None
    if flujo_calor_latente_wm2 is not None:
        try:
            LE_forzado = np.asarray(flujo_calor_latente_wm2, dtype=np.float64)
        except Exception:
            LE_forzado = None
