...
class AIController:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info("[OK] DialogManager inicializado")
            ...
            if self.bus:
                ...
                logger.info("[OK] Bus registrado en orchestrator")
            
            # Iniciar orchestrator (ejecuta en background)
            self.orchestrator.start_sync()
            logger.info("[OK] Orchestrator iniciado")
    ...
    async def shutdown(self):
        ...
        try:
            ...
            if self.orchestrator:
                ...
                logger.info("[OK] Orchestrator detenido")
            
            logger.info("[OK] Sistema de IA apagado")
        
        except Exception as e:
            logger.error(f"[ERROR] Error apagando IA: {e}")
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        if self.initialized:
            try:
                ...
                logger.error(f"[ERROR] Error obteniendo status: {e}")
                status["error"] = str(e)
    ...
    def schedule_autoheal_scan(self):
        ...
        def scan_task():
            ...
            logger.info(f"[BUSCAR] Scan completado: {len(issues)} problemas detectados")
            return issues
