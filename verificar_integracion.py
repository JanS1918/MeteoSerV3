...
try:
    ...
    print("[OK] Integrador importado correctamente")
    ...
    print(f"[ERROR] Error al importar integrador: {e}")
    sys.exit(1)

try:
    from core.indices.deardorff_v46_5_final_sentencia import calcular_temperatura_minima_v46_5_final
    print("[OK] Deardorff V46.5 FINAL importado correctamente")
except ImportError as e:
    print(f"[ERROR] Error al importar Deardorff V46.5 FINAL: {e}")
    sys.exit(1)
