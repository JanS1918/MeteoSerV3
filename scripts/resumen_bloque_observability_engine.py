#!/usr/bin/env python3
"""Resumen por bloque de subfactores en observability_engine."""
...
OUT_MD = ROOT / "output" / "bloque_observability_engine.md"
TARGET_FILE = "core/system/observability_engine.py"
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# Bloque: observability_engine")
    lines.append("")
