#!/usr/bin/env python3
"""Resumen por bloque de subfactores en environmental_indices."""
...
OUT_MD = ROOT / "output" / "bloque_environmental_indices.md"
TARGET_FILE = "core/indices/environmental_indices.py"
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# Bloque: environmental_indices")
    lines.append("")
