#!/usr/bin/env python3
"""Resumen por bloque de subfactores en suggest_engine."""
...
OUT_MD = ROOT / "output" / "bloque_suggest_engine.md"
TARGET_FILE = "core/ia/suggest_engine.py"
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# Bloque: suggest_engine")
    lines.append("")
