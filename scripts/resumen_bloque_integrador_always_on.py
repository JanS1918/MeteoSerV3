#!/usr/bin/env python3
"""Resumen por bloque de subfactores en integrador_always_on."""
...
OUT_MD = ROOT / "output" / "bloque_integrador_always_on.md"
TARGET_FILE = "core/integration/integrador_always_on.py"
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# Bloque: integrador_always_on")
    lines.append("")
