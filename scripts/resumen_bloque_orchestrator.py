#!/usr/bin/env python3
"""Resumen por bloque de subfactores en orchestrator."""
...
OUT_MD = ROOT / "output" / "bloque_orchestrator.md"
TARGET_FILE = "core/ai/orchestrator.py"
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# Bloque: orchestrator")
    lines.append("")
