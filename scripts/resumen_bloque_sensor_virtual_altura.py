#!/usr/bin/env python3
"""Resumen por bloque de subfactores en sensor_virtual_altura."""
...
OUT_MD = ROOT / "output" / "bloque_sensor_virtual_altura.md"
TARGET_FILE = "core/sensors/sensor_virtual_altura.py"
...
def main() -> int:
    ...
    lines: list[str] = []
    lines.append("# Bloque: sensor_virtual_altura")
    lines.append("")
