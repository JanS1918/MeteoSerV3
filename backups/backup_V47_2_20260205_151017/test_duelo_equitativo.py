...
print(f"✅ {len(históricos)} muestras de datos simulados (Argentona)")
...
if resultados_vapor:
    ...
    print("="*80)
    print("📊 RESUMEN PRESIÓN DE VAPOR")
    print("="*80)
...
if ganador_vapor == "IAPWS-95 MEJORADA":
    print("✅ SÍ - IAPWS-95 + Enhancement Factor es marginalmente mejor (~0.3%)")
    ...
    print("❌ NO - Hardy sigue siendo mejor")
print()
