    ...
    def aplicar_mejora_simulada(
        ...
        if diag.tiene_ruido:
            ...
            if mejora_pct > 0:  # Solo si mejora
                ...
                logger.debug(f"  ✅ EWMA aplicado: {mejora_pct:.1f}% mejora")
        ...
        if diag.tiene_outliers:
            ...
            if mejora_pct > 0:
                ...
                logger.debug(f"  ✅ Clipping aplicado: {mejora_pct:.1f}% mejora")
        ...
        if diag.rango_valores > 0 and len(outputs_mejorados) > 0:
            ...
            if mejora_pct > 0:
                ...
                logger.debug(f"  ✅ Normalización aplicada: {mejora_pct:.1f}% mejora")
