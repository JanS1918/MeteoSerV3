...
class ExternalFormulaIntegrator:
    ...
    def integrar_ganadora(
        ...
        if not wrapper_code:
            logger.error("❌ No se pudo generar wrapper")
        ...
        try:
            ...
            logger.info(f"   ✅ Wrapper guardado: {wrapper_path}")
        except Exception as e:
            logger.error(f"❌ Error guardando wrapper: {e}")
            self._log_integracion(
                parametro, externa_id, externa_nombre, wrapper_id,
        ...
        try:
            ...
            logger.info(f"   ✅ Wrapper importable")
        except Exception as e:
            logger.error(f"❌ Wrapper no importable: {e}")
            self._log_integracion(
                parametro, externa_id, externa_nombre, wrapper_id,
        ...
        logger.info(f"✅ Ganadora integrada exitosamente")
        return True
