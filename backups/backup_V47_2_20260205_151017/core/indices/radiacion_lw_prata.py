...
if __name__ == "__main__":
    ...
    print("📊 TEST 1: Noche despejada fría")
    T_k = 278.15  # 5°C
    ...
    print("📊 TEST 2: Noche despejada húmeda")
    T_k = 293.15  # 20°C
    ...
    print("📊 TEST 3: Noche nublada (N=0.8)")
    T_k = 285.15  # 12°C
    e_pa = 1200.0
    ...
    print("📊 TEST 4: Procesamiento vectorizado (24 horas)")
    ...
    print("✅ TESTS COMPLETADOS - Prata (1996) funcional")
