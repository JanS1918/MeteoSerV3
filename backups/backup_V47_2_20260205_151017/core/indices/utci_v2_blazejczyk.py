...
if __name__ == "__main__":
    ...
    print("📊 TEST 1: Condiciones normales (T=20°C, RH=60%)")
    resultado = utci_v2_blazejczyk(
        T_air_c=20.0,
        T_mrt_c=25.0,
        v_wind_m_s=2.0,
    ...
    print("📊 TEST 2: Alta humedad Maresme (T=30°C, RH=95%)")
    resultado = utci_v2_blazejczyk(
        T_air_c=30.0,
        T_mrt_c=40.0,
        v_wind_m_s=1.5,
    ...
    print("📊 TEST 3: Calor extremo (T=42°C, RH=40%)")
    resultado = utci_v2_blazejczyk(
        T_air_c=42.0,
        T_mrt_c=55.0,
        v_wind_m_s=3.0,
    ...
    print("📊 TEST 4: Frío extremo (T=-15°C, RH=70%)")
    resultado = utci_v2_blazejczyk(
        T_air_c=-15.0,
        T_mrt_c=-20.0,
        v_wind_m_s=5.0,
    ...
    print("📊 TEST 5: Viento racheado (T=25°C, v=8 m/s)")
    resultado = utci_v2_blazejczyk(
        T_air_c=25.0,
        T_mrt_c=28.0,
    ...
    print("✅ TESTS COMPLETADOS - UTCI v2 funcional")
    print("\n💡 OBSERVACIONES:")
