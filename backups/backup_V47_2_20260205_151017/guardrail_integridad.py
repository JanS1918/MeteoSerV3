...
for concepto, categoria in CONCEPTOS_CRITICOS.items():
    ...
    if encontrado:
        print(f"✅ {concepto:<20} ({categoria})")
    else:
        print(f"❌ {concepto:<20} ({categoria}) - ¡NO ENCONTRADO EN CÓDIGO!")
        todos_ok = False

print("\n" + "="*80)

if todos_ok:
    print("✅ GUARDRAIL PASADO - Sistema íntegro, listo para operar")
    print("="*80 + "\n")
    sys.exit(0)
else:
    print("🚨 GUARDRAIL FALLIDO - PROMESAS DETECTADAS SIN CÓDIGO")
    print("="*80)
    print("""
