...
class ValidadorCascada:
    ...
    def validar_sensores(self, sensores: Dict[str, float], 
        ...
        if not indices_disponibles:
            recomendaciones.append("⚠️ NINGÚN ÍNDICE DISPONIBLE - Revisar sensores principales")
    ...
    def resumen_cascada(self, resultado_validacion: Dict) -> str:
        ...
        if resultado_validacion.get("cascada_valida"):
            lineas.append("✅ CASCADA VÁLIDA - Todos los índices disponibles pueden calcularse")
        else:
            lineas.append("❌ CASCADA ROTA - Algunos índices no pueden calcularse")
