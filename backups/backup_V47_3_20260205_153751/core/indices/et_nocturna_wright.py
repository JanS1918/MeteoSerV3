...
if __name__ == "__main__":
    ...
    print("📊 TEST 3: Amanecer (transición)")
    resultado = evapotranspiracion_penman_monteith_wright(
        temp_c=15.0,
    ...
    print("\n✅ TESTS COMPLETADOS - Wright (2005) funcional")
    print("\n💡 OBSERVACIONES:")
