...
def cargar_reporte():
    ...
    if not reporte_path.exists():
        print("❌ Primero ejecuta: python test_duelos_simulacion_completa.py")
        return None
...
def main():
    ...
    if confiabilidad >= 85:
        print(f"""
✅ El sistema de DUELOS está VALIDADO y FUNCIONANDO correctamente.
...
""")
        ...
        print(f"""
❌ El sistema de DUELOS necesita REVISIÓN antes de usarse.
