...
class BusExpander:
        ...
        try:
            ...
            if radiacion_real > 10:
                ...
                try:
                    ...
                    from datetime import datetime
                    lat = self.system.location.get("latitud", 41.55)
                    lon = self.system.location.get("longitud", 2.4)
                    altitud = self.system.location.get("altitud", 81.0)
    ...
    async def _publish_inversion_estabilidad(self):
        ...
        try:
            ...
            presion_hpa = presion / 100.0
            g_real = self.bus.leer("gravedad_dinamica") or 9.8028335
    ...
    async def _publish_indices_predictivos_avanzados(self):
        ...
        try:
            ...
            g_gamma = (self.bus.leer("gravedad_dinamica") or 9.8028335) / 1000.0  # K/m → K/km
    ...
    async def _publish_astronomia_optica_avanzada(self):
        ...
        try:
            ...
            g_gamma = (self.bus.leer("gravedad_dinamica") or 9.8028335) / 1000.0  # K/m
