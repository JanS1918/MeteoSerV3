...
def estado():
    try:
        ...
        return estado_panel.model_dump()
    except Exception as e:
    ...
    try:
        ...
        if baromrelin is not None:
            ...
            if 900 <= presion_relativa_hpa <= 1100:
                ...
                actualizar_con_persistencia("presion", presion_rel_rounded, {"tipo": "presion", "unidad": "hPa", "fuente": "HP2550A", "origen": "externo", "fiabilidad": 95.0})
                if hasattr(system, "sensores"):
