"""
═══════════════════════════════════════════════════════════════════════════════
🛡️ GUARDIÁN EXTENDIDO A 30 CAPAS - DOCUMENTACIÓN
═══════════════════════════════════════════════════════════════════════════════
...
VALIDACIONES:
    ...
    ✅ Firma correcta (tiene parámetros)
    ✅ Parámetros reconocidos (temperatura, humedad, etc)
    ✅ Salida sin NaN/Inf en rango normal
    ✅ Sin división por cero
    ✅ Valores extremos procesados
...
EJEMPLO DE EJECUCIÓN:
    ...
    [INFO] 🛡️ CAPA 0: PRE-AUDITORÍA...
    [INFO] ✅ Fórmulas SANAS: 6
    [WARNING] ⚠️ Fórmulas SOSPECHOSAS: 4 (revisar parámetros)
    [ERROR] ❌ Fórmulas DEFECTUOSAS: 3 (descalificadas)
...
════════════════════════════════════════════════════════════════════════════════
🛡️ CAPAS 26-30: POST-DUELO (NUEVA)
════════════════════════════════════════════════════════════════════════════════
...
LÓGICA:
    ...
    3. Si alguna DEFECTUOSA → ❌ Duelo descartado (confianza 0%)
    4. Si alguna SOSPECHOSA → ⚠️ Duelo sospechoso (confianza 60%)
    5. Si ambas SANAS → ✅ Duelo confiable (confianza 95%)
...
EJEMPLO:
    ...
    [INFO] ✅ Duelos CONFIABLES: 3 (aplicar inmediatamente)
    [WARNING] ⚠️ Duelos SOSPECHOSOS: 1 (revisar antes)
    [ERROR] ❌ Duelos DESCARTADOS: 0 (N/A)
...
─────────────────┼──────────────────┼─────────────────────────────────
SANA             | SANA             | ✅ CONFIABLE (95%)
SANA             | SOSPECHOSA       | ⚠️ SOSPECHOSO (60%)
SANA             | DEFECTUOSA       | ❌ DESCARTADO (0%)
SOSPECHOSA       | SANA             | ⚠️ SOSPECHOSO (60%)
SOSPECHOSA       | SOSPECHOSA       | ⚠️ SOSPECHOSO (40%)
SOSPECHOSA       | DEFECTUOSA       | ❌ DESCARTADO (0%)
DEFECTUOSA       | CUALQUIERA       | ❌ DESCARTADO (0%)
...
CASO 1: Guardian detecta Deardorff V46.5 defectuoso
    ...
    ├─ Capas 26-30: ❌ Descarta duelo (V46.5 no sana)
...
CASO 2: Guardian detecta Wright sospechoso (parámetros raros)
    ...
    ├─ Capas 26-30: ⚠️ Sospechoso (revisar parámetros Wright)
...
CASO 3: Guardian detecta ambas sanas (UTCI v1 vs v2)
    ...
    ├─ Capas 26-30: ✅ Confiable (ambas sanas)
...
1. ✅ Valida que nuestras fórmulas son SANAS (Capa 0)
2. ✅ Audita el sistema completo (Capas 1-25)
3. ✅ Valida confiabilidad de decisiones (Capas 26-30)
4. ✅ Previene uso de fórmulas defectuosas
5. ✅ Proporciona confianza en cada acción
