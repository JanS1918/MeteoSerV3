# =============================
# PRINCIPIOS FUNDAMENTALES LIMPIEZA FINAL
# =============================

- Ningún fallo, por menor que sea, queda atrás: TODO se detecta y se arregla.
- Nada se tapa: no se permiten parches ni chapuzas, ni excepciones silenciadas.
- El sistema debe ser:
    - Estable
    - Fluido
    - Preciso
    ...
    - Seguro ante errores y regresiones
- La autovalidación y auto-mejora nunca pueden comprometer la estabilidad ni la calidad.
- Todo cambio queda registrado, validado y es reversible.
- La excelencia técnica y la limpieza de código son innegociables.
