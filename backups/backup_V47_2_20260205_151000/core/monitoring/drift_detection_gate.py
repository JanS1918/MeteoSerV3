...
class DriftDetectionGate:
    ...
    def analyze(self, formula_name: str) -> DriftAnalysis:
        ...
        reason = (f"✅ Drift OK: p95={latency_p95:.3f}s, var={variance:.3f}" if passed
                 else f"❌ Drift excedido: p95={latency_p95:.3f}s > {self.LATENCY_P95_THRESHOLD}s, var={variance:.3f} > {self.VARIANCE_THRESHOLD}")
