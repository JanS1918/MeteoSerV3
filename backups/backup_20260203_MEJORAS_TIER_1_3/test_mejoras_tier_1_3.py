...
def test_config_loader_basico():
    ...
    assert config.get("ubicacion.latitud_grados") == 41.5513
    assert config.get("ubicacion.longitud_grados") == 2.3998
...
def test_config_ubicacion():
    ...
    assert ubi["latitud"] == 41.5513
    assert ubi["altitud_suelo_m"] == 96.0
