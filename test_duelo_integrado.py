...
if not hasattr(motor, "ejecutar_duelo"):
    pytest.skip("FormulaDuelEngine no expone ejecutar_duelo", allow_module_level=True)
...
if len(formulas) >= 2:
    ...
    print('[WARNING] No hay suficientes fórmulas en catálogo')
