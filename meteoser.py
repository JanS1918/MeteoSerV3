...
def main():
    ...
    # [LAUNCH] AUTO-INSTRUMENTACIÓN V29.0: Activar captura automática de TODOS los subfactores
    logger.info("═" * 80)
    logger.info("[LAUNCH] AUTO-INSTRUMENTACIÓN V29.0: Activando captura automática...")
    ...
    if bus_instance:
        ...
        logger.info(f"[OK] Instrumentación completa: {sum(stats.values())} funciones activas")
    else:
        logger.warning("[WARNING] Bus Global no encontrado, auto-instrumentación desactivada")
