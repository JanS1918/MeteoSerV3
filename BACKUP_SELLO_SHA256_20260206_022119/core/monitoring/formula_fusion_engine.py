...
class FormulaFusionEngine:
    ...
    def _evaluar_fusion(
        ...
        for datos in datos_prueba:
            try:
                resultado_principal = formula_principal(**datos)
                resultado_complemento = formula_complemento(**datos)
    ...
    def _evaluar_complemento(
        ...
        for datos in datos_prueba:
            try:
                resultado_actual = formula_actual(**datos)
                resultado_externo = formula_externa(**datos)
