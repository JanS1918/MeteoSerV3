...
# ═══════════════════════════════════════════════════════════════════════════════
# WRAPPER PARA MOTOR DE DUELOS (compatibilidad con FORMULA_HIERARCHY)
# ═══════════════════════════════════════════════════════════════════════════════
...
def omm_densidad_temperatura_virtual(temp_c: float, presion: float, humedad_relativa_pct: float) -> float:
    ...
    try:
        ...
        return calcular_densidad_omm(temp_c, presion_pa, humedad_relativa_pct, e_pa, w_g_kg)
    except Exception:
        return 0.0
...
if __name__ == "__main__":
    ...
    print("\n" + "═" * 80)
    print("[OK] OMM (WMO) operacional. Densidad con Temperatura Virtual confirmada.")
    print("═" * 80)
