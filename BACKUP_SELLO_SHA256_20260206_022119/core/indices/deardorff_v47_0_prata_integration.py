"""
════════════════════════════════════════════════════════════════════════════════
[GUARDIAN] DEARDORFF V47.0 - INTEGRACIÓN CON PRATA (1996)
════════════════════════════════════════════════════════════════════════════════
...
def inicializar_deardorff_v47_0():
    ...
    logger.info("[OK] Deardorff V47.0 + Prata (1996) inicializado para Argentona")
...
def test_deardorff_v47_0_prata():
    ...
    logger.info("\n[STATS] ESCENARIO 1: Noche despejada típica")
    ...
    logger.info("\n[STATS] ESCENARIO 2: Noche nublada")
    ...
    logger.info("\n[OK] TEST COMPLETADO - Deardorff V47.0 + Prata (1996) funcional")
    logger.info("   Mejora esperada: ±0.5°C → ±0.2°C en T_min nocturna")
