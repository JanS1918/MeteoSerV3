...
class SensorVirtualAltura:
    ...
    def actualizar_desde_contexto(self, contexto) -> None:
        ...
        try:
            ...
            logger.debug(f"[OK] Sensor virtual altura actualizado desde contexto")
            ...
            logger.warning(f"[WARNING] Error actualizando sensor virtual: {e}")
    ...
    def _publicar_en_bus(self) -> None:
        ...
        try:
            ...
            logger.warning(f"[WARNING] Error publicando sensor virtual en bus: {e}")
