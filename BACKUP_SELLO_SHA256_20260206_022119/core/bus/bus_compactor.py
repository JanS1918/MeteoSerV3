...
class CompactorBus:
        ...
        with self._lock:
            ...
            for nombre_existente, valor_existente in self.cache_valores_recientes.items():
                if str(valor_existente) == valor_str and nombre_existente != nombre:
                    ...
                    logger.debug(f"[REINICIO] Deduplicación: '{nombre}' = '{nombre_existente}'")
    ...
    def compactar_ciclo(self, parametros_actuales: Dict[str, Any]) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            logger.debug(f"[REINICIO] COMPACTACIÓN - Ciclo {self.ciclo_actual}")
            ...
            if parametros_inactivos:
                logger.warning(
                    f"[WARNING]  Parámetros inactivos detectados ({len(parametros_inactivos)}):\n"
    ...
    def limpiar_ciclo(self):
        ...
        with self._lock:
            ...
            logger.info("[REINICIO] Compactor reseteado para nuevo ciclo")
