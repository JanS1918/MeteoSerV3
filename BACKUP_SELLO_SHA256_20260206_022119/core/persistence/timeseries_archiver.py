...
class ArchivadorSeriesTemporales:
    ...
    def iniciar(self, intervalo_segundos: int = 30):
        ...
        if not self.db_manager or not self.db_manager.conectado:
            print("[ERROR] DB Manager no conectado")
            return False
        
        if self.archivando:
            print("[WARNING]  Archivador ya iniciado")
            return False
    ...
    def detener(self):
        ...
        print(f"[OK] Archivador detenido ({self.total_puntos_escritos} puntos escritos)")
    ...
    def _bucle_archivado(self):
        ...
        while self.archivando:
            try:
                ...
                print(f"[ERROR] Error en bucle de archivado: {e}")
    ...
    def _archivar_capa_bus(self, nivel: str):
        ...
        try:
            ...
            print(f"[ERROR] Error archivando capa {nivel}: {e}")
