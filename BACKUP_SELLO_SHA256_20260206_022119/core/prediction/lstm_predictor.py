...
try:
    ...
    TF_AVAILABLE = False
    print("[WARNING] TensorFlow no disponible. Instalarlo con: pip install tensorflow")
...
def entrenar_modelo_utci(bus, 
    ...
    Returns:
        Modelo entrenado
    """
    print(f"\n[LAUNCH] Entrenando modelo LSTM para predicción UTCI (+{horizonte} min)...")
    ...
    print(f"   [OK] Preparados: {len(X)} secuencias de entrenamiento")
    ...
    print(f"   [OK] Entrenado: val_loss={final_loss:.4f}, val_mae={final_mae:.4f}")
