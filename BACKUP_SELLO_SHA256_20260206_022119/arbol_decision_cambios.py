...
ANTES (Solo Reactivo):
  [ERROR] Cambios inválidos → Se aplican
  [ERROR] Cambios degradadores → Se aplican
  ⏳ 2-4 semanas → Se detectan
  😞 5-10% daño típico → Se revierte

DESPUÉS (Proactivo + Reactivo):
  [OK] Cambios inválidos → SE BLOQUEAN (< 1 segundo)
  [OK] Cambios degradadores → Se bloquean o detectan rápido
...
─────────────────────────┼──────────────┼──────────────┼──────────
Completamente válido    | [OK] OK        | [OK] OK        | Sin cambio
Parcialmente válido      | [ERROR] Falla     | [ERROR] Bloqueado | MEJOR
Inválido                | [ERROR] Falla     | [ERROR] Bloqueado | MEJOR
Degradador              | [ERROR] Falla     | [ERROR] Bloqueado | MEJOR
Sesgo en datos          | [ERROR] Falla     | [ERROR] Bloqueado | MEJOR
...
Watchdog procesa:
  ...
  3. CAPA 3 (EXISTENTE): monitoring continuo
     └─ Si falla: [CRITICAL] alert + rollback
...
if __name__ == "__main__":
    ...
    print("="*80)
    print("[OK] ÁRBOL DE DECISIÓN COMPLETO")
    print("="*80 + "\n")
