...
if baromrelint is not None:
    try:
        ...
        if presion_relativa_hpa > 900 and presion_relativa_hpa < 1100:
            ...
            system.bus.publicar("presion_relativa_interior", presion_relativa_rounded, "hPa")
            system.bus.publicar("presion_relativa_exterior", presion_relativa_rounded, "hPa")
            system.bus.publicar("presion", presion_relativa_rounded, "hPa")
            
            system.actualizar_sensor("presion_relativa_interior", presion_relativa_rounded)
            system.actualizar_sensor("presion_relativa_exterior", presion_relativa_rounded)
...
if baromabsint is not None:
    try:
        ...
        if presion_absoluta_hpa > 900 and presion_absoluta_hpa < 1100:
            ...
            system.bus.publicar("presion_absoluta_exterior", presion_absoluta_rounded, "hPa")
            
            system.actualizar_sensor("presion_absoluta_interior", presion_absoluta_rounded)
            system.actualizar_sensor("presion_absoluta_exterior", presion_absoluta_rounded)
