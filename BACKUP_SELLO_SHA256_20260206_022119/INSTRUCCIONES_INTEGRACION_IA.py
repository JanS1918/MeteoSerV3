...
async def startup_event():
    ...
    logger.info("[LAUNCH] Iniciando MeteoSer...")
    ...
    logger.info("[OK] MeteoSer completamente iniciado")
...
async def shutdown_event():
    ...
    logger.info("[OK] MeteoSer apagado")
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print()
    print("[OK] Sistema de IA ya integrado en main_asgi.py")
    print("[OK] Configura OPENROUTER_API_KEY en variables de entorno")
    print("[OK] Reinicia MeteoSer: python arrancar_meteoser.py")
    print("[OK] Accede a http://localhost:8080/docs para ver todos los endpoints")
    print("[OK] Prueba: http://localhost:8080/ai/status")
    print()
