...
async def process_dialog(data: DialogMessage):
    ...
    try:
        ...
        logger.error(f"[ERROR] Error en diálogo: {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def list_contracts():
    ...
    try:
        ...
        logger.error(f"[ERROR] Error listando contratos: {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_contract(contract_id: str):
    ...
    try:
        ...
        logger.error(f"[ERROR] Error obteniendo contrato: {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def generate_code(data: GenerateCodeRequest):
    ...
    try:
        ...
        logger.error(f"[ERROR] Error generando código: {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def trigger_autoheal_scan():
    ...
    try:
        ...
        logger.error(f"[ERROR] Error programando scan: {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_history(limit: int = 100):
    ...
    try:
        ...
        logger.error(f"[ERROR] Error obteniendo historial: {e}")
        raise HTTPException(status_code=500, detail=str(e))
